...
MIN_COVAR = 1e-3       # regularization floor added to each state's covariance
                       # diagonal; guards against a state collapsing onto too
                       # few points and producing a singular (non-invertible)
                       # covariance matrix during EM
